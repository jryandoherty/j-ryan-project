...
const Logos = () => {
  return (
    ...
    <section class="logos home-icons" id="logos">
        ...
        <Link to="/branding/vertibid/"><img src="https://res.cloudinary.com/jryandoherty/image/upload/v1729274904/vertibid_white_jtribv.svg" alt="Vertibid branding" /></Link>
        ...
        <Link to="/sites/windowz/"><img src="https://res.cloudinary.com/jryandoherty/image/upload/v1747415413/logos/windowz-nqvtxg.svg" alt="Windowz by Liberty logo"  /></Link>
        <Link to="/sites/min-chula/"><img src="https://res.cloudinary.com/jryandoherty/image/upload/v1747415027/logos/min-logo-orange_sfjanx.svg" alt="Min and Chula branding" /></Link>
