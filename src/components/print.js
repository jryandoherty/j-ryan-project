...
const Print = () => {
  return (
    ...
    <section class="thumbnails print" id="brochures">
      <h1>print</h1>
        <img src="https://res.cloudinary.com/jryandoherty/image/upload/v1688593985/blArtboard_1_y9hh5i.svg" alt="II IIII Productions pass front" style={{borderRadius:`30px`}} />
        <img src="https://res.cloudinary.com/jryandoherty/image/upload/v1688593986/blArtboard_2_db76tt.svg" alt="II IIII Productions pass back" style={{borderRadius:`30px`}} />
