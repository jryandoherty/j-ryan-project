...
const Print = () => {
  return (
    ...
    <section class="logos print home-icons" id="brochures">
        ...
        <a href={businessListings} target="_blank" rel="noreferrer"><img src="https://res.cloudinary.com/jryandoherty/image/upload/v1648574293/thumbs_brochures/business_listings_i1wmil.png" alt="Business Listings flyer" style={{background:`#eee`,padding:`6px`,border:`4px solid #333`}} /></a>
    </section>
