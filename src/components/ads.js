...
const Ads = () => {
  return (
    ...
    <section class="ads" id="ads">
      ...
      <img src="https://res.cloudinary.com/jryandoherty/image/upload/v1693004522/access_control2_mrrrtd.jpg" alt="ad-3" className="rectangle" />
      <img src="https://res.cloudinary.com/jryandoherty/image/upload/v1693004786/forklifts_bmviqt.jpg" alt="ad-3" className="rectangle" />
      <img src="https://res.cloudinary.com/jryandoherty/image/upload/v1693004503/industrial_hero_kuprkb.jpg" alt="ad-3" className="rectangle" />
      <img src="https://res.cloudinary.com/jryandoherty/image/upload/v1693004816/payroll2_gk17be.jpg" alt="ad-3" className="rectangle" />
      <img src="https://res.cloudinary.com/jryandoherty/image/upload/v1693004869/bps2_is5xg6.jpg" alt="ad-3" className="rectangle" />
