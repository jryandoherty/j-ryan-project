...
const Websites = () => {
  return (
    ...
    <div class="col-lg-12 d-flex align-items-center justify-content-center flex-wrap flex-shrink">
      ...
      <Link to="/sites/bdc-partner/" class="m-4">
        <StaticImage
      ...
      <Link to="/sites/outer-space/" class="m-4">
        <StaticImage
      ...
      <Link to="/sites/cryptids/" class="m-4">
        <StaticImage
      ...
      <Link to="/sites/grabcad/" class="m-4">
        <StaticImage
      ...
      <Link to="/sites/avian-records/" class="m-4">
        <StaticImage
      ...
      <Link to="/sites/louis-mian/" class="m-4">
        <StaticImage
      ...
      <Link to="/sites/us-chamber/" class="m-4">
        <StaticImage
      ...
      <Link to="/sites/min-chula/" class="m-4">
        <StaticImage
      ...
      <Link to="/sites/buyerzone-2015/" class="m-4">
      <StaticImage
      ...
      <Link to="/sites/leads-2016/" class="m-4">
      <StaticImage
