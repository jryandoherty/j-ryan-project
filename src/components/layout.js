  ...
  return (
    <>
      <Helmet>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Nova+Round&family=Source+Code+Pro:wght@400;500&display=swap"
          rel="stylesheet"
        />

        <meta
          name="google-site-verification"
          content="EtahvMSnu3hGZ5VJ74bsnZdq4VszXFfZ2q2KOqYEsjw"
        />
      </Helmet>
      ...
      >
        ...
        >
          ...
          <p>
            <a href="/">home</a> | <a href="/portfolio/">projects</a> |{" "}
            <a href="mailto:ryan@jryandoherty.com">ryan@jryandoherty.com</a>
          </p>
          <nav class="justify-content-center d-flex" id="social-media-links">
            <ul class="nav">
              <li>
                <a
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  aria-label="visit code samples on GitHub"
                >
