  ...
  <Helmet
    ...
    <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 text-center text-lg-end mt-5 mt-lg-0"><img src="https://master--verdant-kringle-235340.netlify.app/portfolio/2016/construction/img/headline_construction.svg" alt="business" class="w-75" /></div>
      </div>{/* end row */}
