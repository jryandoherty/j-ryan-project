    ...
    <div class="row">
      <div class="col-lg-7">
        <div class="legend">
          ...
          <p class="mt-4">A conversion‐focused web project designed for digital copier shoppers. The goal was to direct users via a marketing email to a landing page optimized to convert site visitors who are looking for digital copiers into leads or sales.</p>
          <p><strong>Target audience:</strong> People who are in the market for digital copiers: comparing cost, features, specs, and seeking quotes.</p>
        </div>
      </div>
    </div>
