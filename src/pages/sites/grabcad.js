      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="legend">
            ...
            <ul>
              <li>
                <strong>Client:</strong> GrabCad
              </li>
              <li>
                <strong>Platform:</strong> Wordpress
              </li>
              <li>
                <strong>Theme:</strong> Unicon
              </li>
              <li>
                <a
                  href="https://github.com/jryandoherty/grabcad"
                  target="_blank"
                  rel="noreferrer"
                  aria-label="github"
                >
            ...
            <p>
              Wordpress blog for GrabCAD, an online community of engineers,
              designers, and manufacturers. Their marketing team needed to
              update the blog with a fresh look that was also mobile friendly.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="container-fluid">
      <div class="row mt-4">
        <div class="col-lg-12 webpage mb-5">
          <object
            name="frame"
            data="https://blog.grabcad.com/blog/category/engineering-management-2/"
