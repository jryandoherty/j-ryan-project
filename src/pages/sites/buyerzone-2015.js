    ...
    <div class="container">
        ...
        <div class="col-lg-6">
          <div class="legend legend-thumbnails">
            ...
            <li><strong>Platform:</strong> Bootstrap 3.0</li>
            <li><strong>Typeface:</strong> Raleway, Avenir</li>
              <li><a href="https://github.com/jryandoherty/bz_home_2015" target="_blank" rel="noreferrer"><svg viewBox="0 0 32 32" class="github">
              ...
              <li>In 2015, I led the digital design and front-end development for Buyerzone.com’s rebrand. I refreshed the logo with a modern, more professional type treatment and rebuilt the outdated website using the Bootstrap framework, creating a cleaner, more user-friendly interface. Collaborating closely with the VP and Senior Director of Marketing, we delivered a brand and site that better reflected the company’s vision and improved the user experience.</li>
            </ul>
          </div>
        </div>
      </div>{/* end row */}
  ...
  <div class="container-fluid mt-5">
    ...
    <div class="row" style={{margin:`3rem 0`}}>
      <div class="col-lg-6 text-center">
        <img src="https://res.cloudinary.com/jryandoherty/image/upload/v1648486756/logos/BZ_logo_buyer_ba7ivj.svg" class="w-50" alt="business" />
      </div>

      <div class="col-lg-6 text-center">
        <img src="https://res.cloudinary.com/jryandoherty/image/upload/v1756235065/logos/logo-bz-buyer_vrdngw.svg" class="w-50" alt="business" />
      </div>
      ...
      <div class="row">
        <div class="col-lg-12 webpage my-5">
          <p>homepage</p>
            <object name="frame" data="https://epicsea.com/portfolio/2015/homepage/index.html" aria-label="live page"></object>
                <div class="stand"></div>
                <div class="base"></div>
                </div>
        </div>{/* end row */}
