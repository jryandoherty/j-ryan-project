  ...
  <Helmet
    ...
    <div class="container">
          ...
          <div class="legend legend-thumbnails">
            ...
            <ul>
              ...
              <li><strong>Typeface:</strong> Raleway, Avenir</li>
                <li><a href="https://github.com/jryandoherty/bz_home_2015" target="_blank" rel="noreferrer" aria-label="live page"><svg viewBox="0 0 32 32" class="github">
      ...
      <div class="col-lg-4 p-2 mt-5">
        <p>logo</p>
        <img src="https://res.cloudinary.com/jryandoherty/image/upload/v1648486756/logos/BZ_logo_buyer_ba7ivj.svg" class="w-100" alt="business" />
      </div>
