        ...
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="legend">
              <h3>PROJECT</h3>
              <ul>
                <li><strong>Client:</strong> Outer Space Arts, LLC</li>
                <li><strong>Date:</strong> May 2023</li>
                <li><strong>Technology:</strong> Bootstrap 5.3 and Gulp</li>
                <li><strong>Typefaces:</strong> BDR Mono and Bookmainia</li>
                <li><a href="https://github.com/jryandoherty/outerspacearts" target="_blank" rel="noreferrer"><svg viewBox="0 0 32 32" class="github">
                ...
                <p class="mt-4">Led the full brand rollout for a new business. Starting with designing the logo, I built the website, signage, and print collateral while providing creative direction and cohesive branding for each gallery exhibition, ensuring a consistent and memorable visual identity.</p>
            </div>{/* end legend */}
          </div>{/* end left column */}
