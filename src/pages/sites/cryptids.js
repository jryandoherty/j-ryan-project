...
const Cryptids = () => (
  ...
  <Helmet
    ...
    <div class="container">
      ...
      <div class="col-lg-6 text-center text-lg-end"><img src="https://www.cryptidscannabis.com/wp-content/uploads/2021/06/cropped-cropped-logo-white.png" alt="business" class="w-50" /></div>
      </div>{/* end row */}
