...
const AvianRecords = () => (
  ...
  <Helmet
    ...
    />
    <Seo title="Sites :: MA Avian Records Committee" />
    <NavBar />
    ...
    <div class="container">
      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          ...
          <ul>
            ...
            <li><strong>Theme:</strong> Teluro</li><li><a href="https://github.com/jryandoherty/maavianrecords" target="_blank" rel="noreferrer"><svg viewBox="0 0 32 32" class="github">
      ...
      <div class="col-lg-6 text-center text-lg-end">
        <img src="https://maavianrecords.com/wp-content/uploads/2022/01/logo_circle.png" alt="logo for MARC" class="w-50" />
      </div>
    ...
    <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-12 webpage my-5">
            <object name="frame" data="https://maavianrecords.com" aria-label="live page"></object>
            <div class="stand"></div>
            <div class="base"></div>
          </div>
