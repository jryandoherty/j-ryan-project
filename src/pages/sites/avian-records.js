      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="legend">
            ...
            <ul>
              <li>
                <strong>Client:</strong> Massachusetts Avian Records
              </li>
              <li>
                <strong>Platform:</strong> Wordpress
              </li>
              <li>
                <strong>Theme:</strong> Teluro
              </li>
              <li>
                <a
                  href="https://github.com/jryandoherty/maavianrecords"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <p>
              Wordpress site for non-profit Massachusetts Avian Records
              Committee.
            </p>
          </div>
        </div>
        ...
        <div class="col-lg-6 text-center text-lg-end">
          <img
            src="https://maavianrecords.com/wp-content/uploads/2022/01/logo_circle.png"
            alt="logo for MARC"
            class="w-50"
          />
        </div>
