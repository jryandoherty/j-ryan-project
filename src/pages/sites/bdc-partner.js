          ...
          <div class="col-lg-6">
            <div class="legend legend-thumbnails">
              ...
              <ul>
                ...
                <li><a href="https://github.com/jryandoherty/bdc_partner" target="_blank" rel="noreferrer"><svg viewBox="0 0 32 32" class="github">
                ...
                <li>Developed a new partnership mini-site for Business.com to showcase its business products. Designed as a recruitment tool for the sales team, the site provided a clear, engaging way to present offerings and attract potential partners.</li>
              </ul>
            </div>
          </div>
        <div class="col-lg-6"><img src="https://res.cloudinary.com/jryandoherty/image/upload/v1693249428/partner-page/cta_mjklsl.svg" alt="business" /></div>
        </div>{/* end row */}
  </div>{/* end container */}
