        ...
        <div class="col-lg-8">
          <div class="legend">
            ...
            <ul>
              ...
              <li>
                <strong>Software:</strong> Photoshop, Illustrator
              </li>
              <li>
                <strong>Technology:</strong> Bootstrap 3.0, FreeMarker(Java),
                JQuery, SCSS, HTML5
              </li>
              <li>
                <a
                  href="https://github.com/jryandoherty/leads_2016"
                  target="_blank"
                  rel="noreferrer"
                  aria-label="GitHub"
                >
              ...
              <li>
                Partnership landing page for Buyerzone.com. Working closly with
                the VP of Marketing and a senior associate of marketing, my role
                was to design a page that could be utilized by the sales
                department to recruit new partners and associates to a lead
                generation program. This fully responsive page was built with
                the Bootstrap framework and features embedded SVGs created in
                Illustrator and multiple animations triggered on scroll.
                Background graphics made in Photoshop. I then adapted the code
                to work in the website's Java framework called Freemarker. After
                BuyerZone was aquired by Purch, the page was reimagined under a
                new brand, <Link to="/sites/bdc-partner/">business.com</Link>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="container-fluid mt-5">
      <div class="row">
        <div class="col-lg-12 webpage">
          <object
            data="https://master--verdant-kringle-235340.netlify.app/portfolio/2016/leads/indexnew/"
