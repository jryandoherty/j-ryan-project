...
const MinChula = () => (
  ...
  <Helmet
    ...
    <div class="col-lg-6">
    <img src="https://res.cloudinary.com/jryandoherty/image/upload/v1689555200/min-phone_rc4vbw.png"  alt="mobile layout" />
    <img src="https://res.cloudinary.com/jryandoherty/image/upload/v1689556633/min-ipad_vhhyja.png"  alt="tablet layout" />
