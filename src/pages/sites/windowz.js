      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="legend">
            ...
            <ul>
              <li>
                <strong>Client:</strong> David Liberty
              </li>
        ...
        <div class="col-lg-6 text-center text-lg-end">
          <img
            src="https://res.cloudinary.com/jryandoherty/image/upload/v1747415413/logos/windowz-nqvtxg.svg"
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12 webpage my-5">
          <object
            name="frame"
            data="https://windowzbyliberty.com"
